...
export const config = {
  ...
  matcher: [
    '/((?!api|blog|images|_next/static|_next/image|sitemap.xml|robots.txt|favicon.ico|icon.png|apple-icon.png|logo.svg|logo-sv.svg|site.webmanifest|apple-touch-icon.png|og-image.png|twitter-image.png).*)',
  ],
};